...
def generate_sfunction_coordinate():
    x_list, y_list, heading_list = [0] * (time_len * fps + 1), [0] * (time_len * fps + 1), [0] * (time_len * fps + 1)
...
def generate_table():
    ...
    table[0] = ['frame_id','type','node_id','dt','x','y','z','length','width','height','heading','PP_x','PP_y','self_x','self_y']
